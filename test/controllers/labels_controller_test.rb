...
class LabelsControllerTest < ActionController::TestCase
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post :create, label: { city: @label.city, contactname: @label.contactname, country: @label.country, labelname: @label.labelname }
    end
  ...
  test "should update label" do
    patch :update, id: @label, label: { city: @label.city, contactname: @label.contactname, country: @label.country, labelname: @label.labelname }
    assert_redirected_to label_path(assigns(:label))
  end
